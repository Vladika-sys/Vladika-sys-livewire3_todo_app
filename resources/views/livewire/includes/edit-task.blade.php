        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form wire:submit.prevent="updateTask()" method="post" id="">
                    ...
                    @endif
                    <button data-modal-hide="defaultModal" type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Edit</button>
                </form>
            </div>
